...
pages.forEach((page) => {
    ...
    useTexture.preload(`/textures/book-cover.png`);
});
...
export const Book = ({ ...props }) => {
    ...
    // Audio flip effect
    const flipAudio = useMemo(() => new Audio("/audios/page-flip-01a.mp3"), []);
    const prevDelayed = useRef(delayedPage);
    useEffect(() => {
        if (prevDelayed.current !== delayedPage) {
            flipAudio.currentTime = 0;
            flipAudio.play();
        }
        prevDelayed.current = delayedPage;
    }, [delayedPage, flipAudio]);
